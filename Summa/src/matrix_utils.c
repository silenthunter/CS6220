 ...
 **/
void
print_matrix (int rows, int cols, double *mat)
{
 ...
 **/
double *
random_matrix_bin (int rows, int cols)
{
 ...
 **/
double *
zeros_matrix (int rows, int cols)
{
 ...
 **/
double *
identity_matrix (int rows, int cols)
{
 ...
 **/
double *
lowerTri_matrix (int rows, int cols)
{
 ...
 **/
void
write_csv (int rows, int cols, double *mat, char *filename)
{
 ...
 */
void
copy_block (int procGridX, int procGridY, int rank, int n, int m,
 ...
 */
void
reorder_matrix (int procGridX, int procGridY, int n, int m, double *src,
		double *dest)
{
 ...
 */
void
distribute_matrix (int procGridX, int procGridY, int n, int m, double *mat,
 ...
 **/
void
verify_element (double a, double b)
{
 ...
 **/
void
verify_matrix (int m, int n, double *A, double *B)
{
  int i;
 ...
 **/
void
allocate_and_distribute (double *mat, double *block, int m, int n,
